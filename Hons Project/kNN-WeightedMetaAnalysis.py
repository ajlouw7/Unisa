...
for dataset in range(1,11):
    fileName = 'Analysis\\kNN-Analysis-Weighted-Run' + str(dataset) + '.csv'
...
analysisdf.to_csv('Analysis\\kNN-WeightedMetaAnalysis_Interim.csv')
...
resultdf.to_csv('Analysis\\kNN-WeightedMetaAnalysis.csv')
