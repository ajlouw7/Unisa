...
Next, the data was run against 1261 and 81 evenly spaces centroids in the solution space. These results can be seen in Table \ref{CentroidResults1296} and Table \ref{CentroidResults81} respectively.
...
Both of these average errors were still larger than the average error determined by the weighted kNN-algorithm.
