...
The first results from the custering alogortihm was where the optimum number of clusters was being determined using random positions of the centroids. As discussed in Section \ref{Clustering Results}, the number of centroids were varied between 2 and 15.  
