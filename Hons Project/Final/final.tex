...
From a practical point of view, this new evely spaced form of CLS should not run more than 12 hours. That was the amount of time the random version of CLS ran for per fold. Thus a full run should be approximately 120 hours, which is 5 full days. The random version of CLS also had to do the calculations for $\sum_{2}^{15} i = $
