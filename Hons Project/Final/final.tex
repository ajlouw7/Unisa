...
In Figure \ref{kNNResultsAllFolds} we can see a plot of the mean error in life expectancy over all 10 folds versus k. The bands indicate the standard deviation of the data
...
\end{tabular}
\label{kNNResultsPerFold}
\caption{Mean Error in Predicted Life Expectancy per Fold for the kNN Algortihm}
\end{figure}
