...
As described in Section \ref{regression} the OLS algorihm was implemented in Python and run for each fold of the data. The results can be see in Table \ref{OLSResults} 
