...
for dataset in range(1,10):
    for fold in range(1,11):
        fileName = 'Analysis\\Cluster-Analysis-Even-Fold' + str(fold) + 'theshold0.001noCentroids=81-Run' + str(dataset) + '.csv'
...
analysisdf.to_csv('Analysis\\Clustering-MetaAnalysis-Even81.csv')

df= pd.read_csv('Analysis\\Clustering-MetaAnalysis-Even81.csv')
...
finalAnalysisDF.to_csv('Analysis\\Clustering-MetaAnalysis-Even81-Final.csv')
