...
The mean squared error will be calculated for each of the k Cross-Validation datasets for each of the algorithms. The average of each of these mean squared errrs will be calculated for each algorithm.This number will be used to determine the fitness of each algorithm and enables comparison. 
